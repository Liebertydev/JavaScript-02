...
button {
  ...
  margin: 30px auto 0;
  border-radius: 10px;
  box-shadow: 3px 4px 6px rgba(0, 0, 0, 0.781);
}
...
input[type="checkbox"] {
  width: 25px;
  height: 25px;
}`, "",{"version":3,"sources":["webpack://./src/assets/css/style.css"],"names":[],"mappings":"AACA;EACE,iCAAiC;EACjC,sCAAsC;AACxC;;AAEA;EACE,sBAAsB;EACtB,UAAU;AACZ;;AAEA;EACE,SAAS;EACT,UAAU;EACV,gCAAgC;EAChC,oCAAoC;EACpC,gBAAgB;EAChB,kBAAkB;AACpB;;AAEA;EACE,gBAAgB;EAChB,iBAAiB;EACjB,gBAAgB;EAChB,aAAa;EACb,mBAAmB;AACrB;;AAEA;EACE,uCAAuC;AACzC;;AAEA;EACE,YAAY;EACZ,gCAAgC;EAChC,WAAW;EACX,cAAc;EACd,gBAAgB;EAChB,YAAY;EACZ,eAAe;EACf,cAAc;EACd,mBAAmB;EACnB,mBAAmB;EACnB,4CAA4C;AAC9C;;AAEA;EACE,uCAAuC;AACzC;;AAEA;EACE,cAAc;EACd,2BAA2B;EAC3B,cAAc;AAChB;;AAEA;EACE,WAAW;EACX,YAAY;AACd","sourcesContent":["@import url('https://fonts.googleapis.com/css?family=Open+Sans:400,700&display=swap');\n:root {\n  --primary-color: rgb(17, 86, 102);\n  --primary-color-darker: rgb(9, 48, 56);\n}\n\n* {\n  box-sizing: border-box;\n  outline: 0;\n}\n\nbody {\n  margin: 0;\n  padding: 0;\n  background: var(--primary-color);\n  font-family: 'Open sans', sans-serif;\n  font-size: 1.3em;\n  line-height: 1.5em;\n}\n\n.container {\n  max-width: 640px;\n  margin: 50px auto;\n  background: #fff;\n  padding: 20px;\n  border-radius: 10px;\n}\n\ninput:focus {\n  outline: 1px solid var(--primary-color);\n}\n\nbutton {\n  border: none;\n  background: var(--primary-color);\n  color: #fff;\n  font-size: 1em;\n  font-weight: 700;\n  height: 50px;\n  cursor: pointer;\n  display: block;\n  margin: 30px auto 0;\n  border-radius: 10px;\n  box-shadow: 3px 4px 6px rgba(0, 0, 0, 0.781);\n}\n\nbutton:hover {\n  background: var(--primary-color-darker);\n}\n\n.senha-gerada {\n  font-size: 2em;\n  color: var(--primary-color);\n  margin: 40px 0;\n}\n\ninput[type=\"checkbox\"] {\n  width: 25px;\n  height: 25px;\n}"],"sourceRoot":""}]);
// Exports
...
var qtdCaracteres = document.querySelector('.qntCarac');
var chkMaiusculas = document.querySelector('.chk-maiusc');
var chkMinusculas = document.querySelector('.chk-minusc');
var chkNumber = document.querySelector('.chk-num');
var chkSimbolo = document.querySelector('.chk-simbol');
...
function gera() {
  var senha = (0,_geradores__WEBPACK_IMPORTED_MODULE_0__["default"])(qtdCaracteres.value, chkMaiusculas.checked, chkMinusculas.checked, chkNumber.checked, chkSimbolo.checked);
...
function geraSenha(qtd, maiusc, minusc, num, simb) {
  var senhaArray = [];
  qtd = Number(qtd);
  for (var i = 0; i <= qtd; i++) {
